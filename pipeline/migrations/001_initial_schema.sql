...
CREATE TABLE IF NOT EXISTS department_expenditures (
    id SERIAL PRIMARY KEY,
    fiscal_year_id INTEGER NOT NULL REFERENCES fiscal_years(id),
    department_id INTEGER NOT NULL REFERENCES departments(id),
...
CREATE TABLE IF NOT EXISTS strategic_area_budgets (
    id SERIAL PRIMARY KEY,
    fiscal_year_id INTEGER NOT NULL REFERENCES fiscal_years(id),
    strategic_area_id INTEGER NOT NULL REFERENCES strategic_areas(id),
    operating_budget BIGINT,
    capital_budget BIGINT,
    cents_per_dollar INTEGER,
    UNIQUE(fiscal_year_id, strategic_area_id)
);

-- Property tax millage rates (for the tax calculator)
CREATE TABLE IF NOT EXISTS millage_rates (
    id SERIAL PRIMARY KEY,
    fiscal_year_id INTEGER NOT NULL REFERENCES fiscal_years(id),
...
-- AI-generated plain-English descriptions
...
CREATE TABLE IF NOT EXISTS capital_programs (
    id SERIAL PRIMARY KEY,
    fiscal_year_id INTEGER NOT NULL REFERENCES fiscal_years(id),
    department_id INTEGER NOT NULL REFERENCES departments(id),
    strategic_area_id INTEGER NOT NULL REFERENCES strategic_areas(id),
...
CREATE INDEX IF NOT EXISTS idx_dept_budgets_fy ON department_budgets(fiscal_year_id);
CREATE INDEX IF NOT EXISTS idx_dept_budgets_dept ON department_budgets(department_id);
CREATE INDEX IF NOT EXISTS idx_dept_expenditures_fy ON department_expenditures(fiscal_year_id);
CREATE INDEX IF NOT EXISTS idx_revenue_by_source_fy ON revenue_by_source(fiscal_year_id);
CREATE INDEX IF NOT EXISTS idx_disbursements_date ON disbursements(payment_date);
CREATE INDEX IF NOT EXISTS idx_disbursements_dept ON disbursements(department_id);
CREATE INDEX IF NOT EXISTS idx_disbursements_payee ON disbursements(payee_name);
CREATE INDEX IF NOT EXISTS idx_capital_programs_fy ON capital_programs(fiscal_year_id);
CREATE INDEX IF NOT EXISTS idx_budget_descriptions_entity ON budget_descriptions(entity_type, entity_id);
