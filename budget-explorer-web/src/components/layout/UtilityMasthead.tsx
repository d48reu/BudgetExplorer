...
export function UtilityMasthead({
  eyebrow,
  title,
  description,
  metricLabel,
    ...
    <header className="border-t-[6px] border-text-primary">
      ...
      <div className="grid gap-8 py-10 sm:py-14 lg:grid-cols-[minmax(0,1.5fr)_minmax(17rem,0.65fr)] lg:gap-16 lg:py-16">
        <div>
          ...
          <h1 className="mt-5 max-w-4xl font-heading text-[clamp(3rem,7vw,5.5rem)] font-bold leading-[0.9] tracking-[-0.05em] text-text-primary">
            {title}
          </h1>
        ...
        >
          ...
          <p className="mt-3 font-heading text-3xl font-bold leading-tight text-text-primary sm:text-4xl">
            {metricValue}
          </p>
